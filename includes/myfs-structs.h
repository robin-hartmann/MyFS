...
#define NUM_USERID_BYTE 4
#define NUM_GROUPID_BYTE 4
...
#define START_ATIME_BYTE START_ACCESS_RIGHT_BYTE + NUM_ACCESS_RIGHT_BYTE
#define START_MTIME_BYTE START_ATIME_BYTE + NUM_TIMESTAMP_BYTE
